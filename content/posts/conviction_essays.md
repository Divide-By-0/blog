...
- Conviction
  - Ways to get conviction
    - **Media**
      - Reading books gives you conviction in certain ideas – that's why it's important to choose only the authors that are experts in their fields, who have fought the fights and been through the trials and tribulations. [Read widely and differently](https://glibert.io/blog/reading/). I usually recommend the books 'Greatness Cannot be Planned', 'Finite and Infinite Games', and 'Feynman's Rainbow' to start -- you can see longer reviews for those on [my goodreads](https://goodreads.com/yushg). If you're not used to reading for fun often, start building that habit now.
