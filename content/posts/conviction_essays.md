...
- Conviction
  - Ways to get conviction
    - **Media**
      ...
      - I think I've committed the points and stories in this [Steve Jobs 2005 commencement address](https://www.youtube.com/watch?v=D1R-jKKp3NA) basically to memory by this point. His three points are counterintuitive and exactly correct, and his stories are well told. Thanks to DC for the original rec.
    - **Environment**
...
- On optionality
  ...
  - Most people fail to make the transition between max optionality and max focus. Staying in the former leads to you doing little of value, which requires extended focus. Staying in the latter means you settle for a topic too early, and may have preferred choosing a more interesting path.
