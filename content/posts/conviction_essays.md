...
aliases:
  ...
  - /posts/conviction2
  - /posts/fake_conviction
  - /posts/fakeconviction
  - /conviction2
  - /conviction_essays
  - /fake_conviction
  - /fakeconviction
...
- Conviction
  - Ways to get conviction
    ...
    - **Momentum**
      ...
      - If the reasons for their conviction is ever broken, they either find new equally compelling reasons, or switch. Likewise, you should expect that if you start this process, you might find it not compelling for some reason or the other and leave -- and that's totally cool too.
...
- Language splices out bad reasons for conviction
  - Writing communicates subtleties and reasons that go beyond the surface level
  - Information and thus meaning, is encoded in language/imagery. To really make sure your conviction is robust, you better be able to express your convictions through language, not just feeling.
...
- The desire to be surprising, or desire to be impressive
  ...
  - Don't let yourself be the final season of Game of Thrones: a victim of expectations, forced to be "surprising", and arrogant off of their previous successes.
- Just "doing"
...
- Communities
  ...
  - Look instead for places where people are quietly doing good work. People building projects in their dorm rooms, people meeting to build projects without clout and just for fun, and people excited to understand things they're curious about. These will be almost certainly be low status groups in your top college's classical definition of "status", but likely have the most real things you can learn and genuine people you want to work with. Good examples are [Socratica](https://www.socratica.info/) and [Hack Lodge](https://hacklodge.org/), but even you and two friends is a great place to start.
